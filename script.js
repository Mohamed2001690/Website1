...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.course-card, .project-card, .about-text, .contact-info, .contact-form');
...
document.querySelectorAll('.social-link, .social-icons a, .footer-social a').forEach(link => {
